...
const Blog = props => {
  ...
  return (
    <Layout path={props.location.pathname}>
      <BG />
      <SEO title="Elite Swap Blog" path={props.location.pathname} />

      <StyledBlog>
        <PageTitleWrapper>
          <h2 style={{ fontSize: '56px' }}>Elite Swap Blog</h2>
          <p>
            News, stories, documents and announcements from Elite Swap.{' '}
          </p>
        </PageTitleWrapper>
        <PostsWrapper>
