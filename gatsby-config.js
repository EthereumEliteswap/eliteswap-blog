...
module.exports = {
  ...
  siteMetadata: {
    ...
    author: `@EliteswapProtocol`,
    menulinks: menu,
    siteUrl: `https://eliteswap.io`,
    repository: `https://github.com/EthereumEliteswap/eliteswap-blog`,
      ...
      options: {
        ...
        gatsbyRemarkPlugins: [
          ...
          // `gatsby-remark-check-links`,
          {
            ...
            options: {
              title: 'Elite Swap', // website title
              separator: '|', // default
              author: '@EliteswapProtocol',
